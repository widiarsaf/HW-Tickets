                        ...
                        <div class="card rounded-20" style="background-color: #262324; border: 0px;">
                            <div class="card-header" style="display: flex; justify-content: center; ">
                                <h3 class="mb-0" style="color: white;">Booking Movie</h3>
                                    ...
                                    ?>
                                <div class="card-body">
                                <form action="insertProcess.php?id=<?php echo $idmovie;?>" enctype="multipart/form-data" method = "post">
                                            <?php 
                                        ...
                                        <br>
                                        <input type="submit" value="+Add Booking" class="btn" style="background-color: #f38181; color: white;">
                                        <?php 
                                                }
                                        ?>
                                    </form>
